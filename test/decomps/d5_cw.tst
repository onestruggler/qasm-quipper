...
gap> m_cix := SwapAndApply( 2, 1, 2, m_icx );;
gap> m_xic := SwapAndApply( 2, 1, 3, m_cix );;
...
gap> m_b2 := ApplyQuditGateBetween( 2, m_b1, 1, 0 );;
...
gap> m_d2 := ApplyQuditGateBetween( 2, m_d1, 1, 1 );;
gap> m_g4 := m_icx * m_d2;;
